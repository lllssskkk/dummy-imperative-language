...
/* package interperter-0.1.0.0 */
#ifndef VERSION_interperter
#define VERSION_interperter "0.1.0.0"
#endif /* VERSION_interperter */
#ifndef MIN_VERSION_interperter
#define MIN_VERSION_interperter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_interperter */
...
#define CURRENT_COMPONENT_ID "interperter-0.1.0.0-inplace-interperter"
